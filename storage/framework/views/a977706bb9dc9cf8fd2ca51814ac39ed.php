                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <input type="text" class="form-control amount-input" data-key="Amount"
                                value="<?php echo e($row->Amount !== null ? '$' . number_format($row->Amount, 2) : ''); ?>" placeholder="Amount">
                        </td>
                        ...
                        <td>
                            <?php $exeOptions = ['Called & Mailed','Payment Completed','Not Interested','Others','N/A','VM','Busy']; ?>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-primary mail-btn" data-id="<?php echo e($row->id); ?>">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/database/accountantpaid.blade.php ENDPATH**/ ?>