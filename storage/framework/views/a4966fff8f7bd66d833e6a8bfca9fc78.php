                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(route('call.reports.allseniormonthly', $user->id)); ?>" class="btn btn-sm btn-primary">
                                View Monthly
                            </a>

                            <a href="<?php echo e(route('call.reports.allseniordaily', $user->id)); ?>" class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/reports/allseniorlist.blade.php ENDPATH**/ ?>