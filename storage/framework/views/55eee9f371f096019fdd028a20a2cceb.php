    ...
    <div class="card-body p-24">
        <div class="table-responsive scroll-sm">
            <table class="table bordered-table sm-table mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $trainerUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(route('call.reports.alltrainermonthly', $user->id)); ?>" class="btn btn-sm btn-primary">
                                View Monthly
                            </a>

                            <a href="<?php echo e(route('call.reports.alltrainerdaily', $user->id)); ?>" class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/reports/alltrainerlist.blade.php ENDPATH**/ ?>