                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->designation === 'Senior' ? 'IT Senior Recruiter' : $user->designation); ?></span>
                        </li>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/user/senioredit.blade.php ENDPATH**/ ?>