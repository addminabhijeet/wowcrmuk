                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <textarea type="text" name="Remark_hidden" class="form-control remark-autocomplete" placeholder="Type remark"
                                rows="2"><?php echo e($row->Remark ?? ''); ?></textarea>
                        ...
                        <td>
                            <textarea class="form-control transferremark-autocomplete" rows="2" placeholder="Type remark"><?php echo e($row->TransferRemark ?? ''); ?></textarea>
