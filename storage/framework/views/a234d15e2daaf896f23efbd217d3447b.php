            ...
            <div class="card h-100 p-0">
                <div class="card-body p-24">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-1 justify-content-between mb-16">
                        ...
                        <a href="<?php echo e(route('users.junior.create')); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <span
                                                                class="text-sm text-secondary-light fw-medium"><?php echo e($user->email); ?></span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex align-items-center gap-10 justify-content-center">
                                                        <a href="<?php echo e(route('users.junior.edit', $user->id)); ?>"
                                                            class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle">
                                                            <iconify-icon icon="lucide:edit"
                                                                class="menu-icon"></iconify-icon>
                                                        </a>
                                                        <a href="<?php echo e(route('users.junior.destroy', $user->id)); ?>"
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/junior.blade.php ENDPATH**/ ?>