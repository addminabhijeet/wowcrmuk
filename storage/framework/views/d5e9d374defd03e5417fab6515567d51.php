...
<div class="row gy-4">
    <div class="col-lg-4">
        <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100" style="padding-top: 100px;">
            <img src="<?php echo e($user->image ? asset('storage/app/public/' . $user->image) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>"
                alt=""
                class="w-100 object-fit-cover">
            <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                <div class="text-center border border-top-0 border-start-0 border-end-0">
                    <img src="<?php echo e($user->image ? asset('storage/app/public/' . $user->image) : asset('assets/images/user-grid/user-grid-img14.png')); ?>" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->gender === 'Junior' ? 'IT Recruiter' : $user->gender); ?></span>
                        </li>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/junioredit.blade.php ENDPATH**/ ?>