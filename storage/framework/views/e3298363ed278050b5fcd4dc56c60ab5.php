                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <input type="text" class="form-control amount-input" data-key="Amount"
                                value="<?php echo e($row->Amount ? '$' . number_format($row->Amount, 2) : ''); ?>" placeholder="Amount(469)">
                        </td>
                        ...
                        <td>
                            <?php $exeOptions = ['Called & Mailed','Not Interested','Not Connected','Did Not Connect','Others','N/A','VM','Busy']; ?>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(url('dashboard/junior/google-sheet/view-resume/'.$row->id)); ?>" target="_blank" class="btn btn-sm btn-primary view-btn">View PDF</a>
                            <a href="<?php echo e(url('dashboard/junior/google-sheet/download-resume/'.$row->id)); ?>" class="btn btn-sm btn-secondary download-btn">Download</a>
                            <?php else: ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/database/junior.blade.php ENDPATH**/ ?>