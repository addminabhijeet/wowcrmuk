                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $accountantUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($user->role === 'accountant' ? 'Support' : $user->role); ?></td>

                                <td class="text-center">
                                    <a href="<?php echo e(route('call.reports.allaccountantmonthly', $user->id)); ?>"
                                        class="btn btn-sm btn-primary">
                                        View Monthly
                                    </a>

                                    <a href="<?php echo e(route('call.reports.allaccountantdaily', $user->id)); ?>"
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/allaccountantlist.blade.php ENDPATH**/ ?>