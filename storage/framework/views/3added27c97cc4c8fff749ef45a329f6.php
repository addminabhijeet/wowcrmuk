        ...
        <div class="d-flex align-items-center flex-wrap gap-3">
            ...
            <select class="form-select form-select-sm w-auto ps-12 py-6 radius-12 h-40-px" name="junior_user" id="junior-filter">
                ...
                <option value="<?php echo e($junior->id); ?>">
                    ...
                    <?php if($junior->designation): ?> (<?php echo e($junior->designation); ?>) <?php endif; ?>
                </option>
            ...
            <table class="table bordered-table sm-table mb-0">
                ...
                <tbody id="sheet-table-body">
                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <?php $exeOptions = ['Ready To Paid','Not Interested','Not Connected','Did Not Pickup','Others','Payment Completed','VM','Busy']; ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/database/accountant.blade.php ENDPATH**/ ?>