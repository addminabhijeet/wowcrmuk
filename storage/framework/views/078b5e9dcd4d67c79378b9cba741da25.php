...
<div class="row gy-4">
    <div class="col-lg-4">
        <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100" style="padding-top: 100px;">
            <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>"
                alt=""
                class="w-100 object-fit-cover">
            <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                <div class="text-center border border-top-0 border-start-0 border-end-0">
                    <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/user-grid/user-grid-img14.png')); ?>" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">
                                : <?php echo e($user->role === 'junior' ? 'IT Recruiter' : $user->role); ?>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->designation === 'Junior' ? 'IT Recruiter' : $user->designation); ?></span>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-24">
                ...
                <form action="<?php echo e(route('users.junior.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="role" id="role" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="accountant" <?php echo e($user->role == 'trainer' ? 'selected' : ''); ?>>Trainer</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="designation" id="designation" class="form-control radius-8 form-select" required>
                                            <option value="" disabled <?php echo e(!$user->designation ? 'selected' : ''); ?>>Select Designation</option>
                                            <option value="Accountant" <?php echo e($user->designation == 'Accountant' ? 'selected' : ''); ?>>Support</option>
                                            <option value="Admin" <?php echo e($user->designation == 'Admin' ? 'selected' : ''); ?>>Admin</option>
                                            <option value="Candidate" <?php echo e($user->designation == 'Candidate' ? 'selected' : ''); ?>>Candidate</option>
                                            <option value="Junior" <?php echo e($user->designation == 'Junior' ? 'selected' : ''); ?>>IT Recruiter</option>
                                            <option value="Senior" <?php echo e($user->designation == 'Senior' ? 'selected' : ''); ?>>IT Senior Recruiter</option>
                                            <option value="Trainer" <?php echo e($user->designation == 'Trainer' ? 'selected' : ''); ?>>Trainer</option>
                                            <option value="Caller" <?php echo e($user->designation == 'Caller' ? 'selected' : ''); ?>>Caller</option>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/user/junioredit.blade.php ENDPATH**/ ?>