                    ...
                    <div class="mb-16">
                        ...
                        <div class="d-flex gap-2">
                            <select name="hours" class="form-select rounded-pill px-16 py-6">
                                <?php for($h = 0; $h <= 24; $h++): ?>
                                    <option value="<?php echo e($h); ?>" <?php echo e($h == $hours ? 'selected' : ''); ?>><?php echo e($h); ?> h</option>
                                <?php endfor; ?>
                            </select>
                            <select name="minutes" class="form-select rounded-pill px-16 py-6">
                                <?php for($m = 0; $m < 60; $m += 5): ?>
                                    <option value="<?php echo e($m); ?>" <?php echo e($m == $minutes ? 'selected' : ''); ?>><?php echo e($m); ?> m</option>
                                <?php endfor; ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/timers/admin.blade.php ENDPATH**/ ?>