            ...
            <div class="col-xxl-3 col-md-6 user-grid-card">
                <div class="position-relative border radius-16 overflow-hidden" style="padding-top: 30px;">
                    ...
                    <div class="ps-16 pb-16 pe-16 text-center mt--50">
                        <img src="<?php echo e($timer['image'] ? asset('assets/images/user-grid/' . $timer['image']) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>" class="border br-white border-width-2-px w-100-px h-100-px rounded-circle object-fit-cover" alt="">
                        ...
                        <div class="timer-widget"
                            ...
                            <!-- Control Buttons -->
                            <div class="seniorcontrolButtons" id="seniorcontrolButtons_<?php echo e($timer['user_id']); ?>" style="display:flex;align-items:center;gap:4px;flex-wrap:wrap;">
                                <button data-type="resumebreak" data-user="<?php echo e($timer['user_id']); ?>" style="width:65px;height:28px;border-radius:14px;background:#d4edda;border:1px solid #28a745;display:flex;align-items:center;justify-content:center;font-size:12px;color:#28a745;">
                                    <iconify-icon icon="mdi:play" style="margin-right:2px;font-size:14px;"></iconify-icon>Resume
                                </button>
                                <button data-type="lunch" data-user="<?php echo e($timer['user_id']); ?>" style="width:65px;height:28px;border-radius:14px;background:#f8f9fa;border:1px solid #ddd;display:flex;align-items:center;justify-content:center;font-size:12px;color:#ffc107;">
                                    <iconify-icon icon="mdi:food" style="margin-right:2px;font-size:14px;"></iconify-icon>Lunch
                                </button>
                                <button data-type="tea" data-user="<?php echo e($timer['user_id']); ?>" style="width:65px;height:28px;border-radius:14px;background:#f8f9fa;border:1px solid #ddd;display:flex;align-items:center;justify-content:center;font-size:12px;color:#8b4513;">
                                    <iconify-icon icon="mdi:coffee" style="margin-right:2px;font-size:14px;"></iconify-icon>Tea
                                </button>
                                <button data-type="break" data-user="<?php echo e($timer['user_id']); ?>" style="width:65px;height:28px;border-radius:14px;background:#f8f9fa;border:1px solid #ddd;display:flex;align-items:center;justify-content:center;font-size:12px;color:#007bff;">
                        ...
                        <div class="position-absolute top-0 end-0 me-16 mt-16" id="badgeContainer_<?php echo e($timer['user_id']); ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.user-action-btn').on('click', function() {
            ...
            var url = actionType === 'logout' ? "<?php echo e(route('ajax.logout')); ?>" : "<?php echo e(route('ajax.login')); ?>";
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u235777426/domains/admin.pdfreducer.com/public_html/resources/views/timers/allsenior.blade.php ENDPATH**/ ?>