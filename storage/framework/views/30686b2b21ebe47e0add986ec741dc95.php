                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $trainerUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(route('calendar.alltrainerUser', $user->id)); ?>"
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/calendar/alltrainerlist.blade.php ENDPATH**/ ?>