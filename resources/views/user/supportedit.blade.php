                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: {{ $user->gender === 'Support' ? 'Senior Support Associate' : $user->gender}}</span>
                        </li>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="gender" id="gender" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Support" {{ $user->gender == 'Support' ? 'selected' : '' }}>Senior Support Associate</option>
