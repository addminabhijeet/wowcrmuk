                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: {{ $user->gender === 'Writer' ? 'Resume Writer' : $user->gender}}</span>
                        </li>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="gender" id="gender" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Writer" {{ $user->gender == 'Writer' ? 'selected' : '' }}>Resume Writer</option>
